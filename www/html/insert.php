...
[<a href="insert.php?res=<?php echo h($post['id']);?>">Re</a>]</p>
...
<ul class="paging">
    ...
    if ($page>1) {
        ?>
    <li><a href="insert.php?page=<?php print($page-1); ?>">前のページへ</a></li>
    <?php
    }else{
        ?>
    <li>前のページへ</li>
    ...
    if($page<$maxPage){
    ?>
    <li><a href="insert.php?page=<?php print($page+1); ?>">次のページへ</a></li>
    <?php
    }else{
        ?>
    <li>次のページへ</li>
